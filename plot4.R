...
# Subset SCC coal-combustion related
SCCsub<-SCC[grep("coal | Coal", SCC$Short.Name),]$SCC
NEIsub<-subset(NEI, SCC %in% SCCsub)
...
title(main="PM2.5 Total Emissions from coal combustion in US")
dev.off()